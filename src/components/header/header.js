  ...
  return (
    <div className="container-fluid header">
      <Row className="container align-items-center">
        ...
        <Col className="showFormSearch" xs={8} sm={8} md={8} lg={8} xl={8}>
          <Input
          ...
          />
          {keySearch.length > 0 && productsHeader && productsHeader.length > 0 && (
              ...
              <Link className="d-flex" to="/cart">
                ...
                {carts && carts.length > 0 && (
                  <div className="text-total-cart">
                    <Typography.Text>{carts.length}</Typography.Text>
                  </div>
                )}
                <Typography.Title className="text-white m-0" level={5}>
                  Giỏ hàng
